...
export default function Register() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-24 p-8 border rounded">
      ...
      <input type="password" className="w-full mb-4 p-2 border rounded" placeholder="Confirm Password" onChange={e => setConfirm(e.target.value)} />
